...
let businessContactRouter = require('../routes/business-contact');
...
let userAccountModel = require('../models/user');
const { BusinessContact } = require('../models/business-contact');
let UserAccount = userAccountModel.User;
